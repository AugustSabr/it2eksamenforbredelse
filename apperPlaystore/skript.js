...
// }
// let a = popularApp(dataJson, 'GAME')
// // console.log(a);

console.log(highestKeys);
...
// for (let i = 0; i < n; i++) {
//   for (let j = 0; j < n; j++) {
//     mostPopularApps.push({ 'kategori': highestKeys[i][0], 'app': 'highestKeys[j][1]', 'installasjoner': 'Math.round(averageInstalls(dataJson, highestKeys[j][0]))' })
//   }
// }
// console.log();
